...
public class Planet 
{
    ...
    public Planet(string name, float us, float radius, Vector3 place)
    {
        ...
        if (name == "P000000")
        {
            planet.GetComponent<MeshRenderer>().material.color = new Color(32f, 48f, 75f, 100f);
            planet.GetComponent<MeshRenderer>().material.SetColor("_EmissionColor", new Color(32f, 48f, 75f, 100f));
